import dashboard.streamlitdash as streamlitdash
from dashboard.streamlitdash import dcc, html, Input, Output
...
app = streamlitdash.Dash(__name__, external_stylesheets=[dbc.themes.BOOTSTRAP])
